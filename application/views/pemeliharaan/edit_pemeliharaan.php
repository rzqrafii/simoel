        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><strong>Edit Data Pemeliharaan <?php echo $edit->platKendaraan;?> </strong></h3>
           ...
           <?php echo form_open_multipart('pemeliharaan/edit'); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    <label for="pemeliharaan">Kondisi Oli</label><br>
                    ...
                    <?php 
                            ...
                            {
                          ?>
                             <input type="radio" name="oliMesin" id="oliMesin"  value="YA"  checked="">
                             YA
                          ...
                          <?php 
                            ...
                            ?>
                            <input type="radio" name="oliMesin" id="oliMesin"  value="YA" >YA
                            <input type="radio" name="oliMesin" id="oliMesin"  value="TIDAK" checked="" >TIDAK
                          <?php
                           }
                          ?>
                </div>
