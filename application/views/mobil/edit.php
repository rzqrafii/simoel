           ...
           <?php echo form_open_multipart('mobil/edit'); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="mobil">Nama Kendaraan</label>
                ...
                <div class="form-group">
                <label for="mobil">Merk Kendaraan</label>
              ...
              <div class="form-group">
                  <label for="mobil">Tanggal Pajak Exp.</label>
                  <input type="text" name="tglPajak" id="tglPajak" class="form-control"  placeholder="Tanggal Pajak Exp." value="<?php echo $edit->tglPajak; ?>">
                </div>
            <!--   <div class="form-group">
              ...
              <div class="form-group">
                  <label for="merk">Plat Nomor Mobil</label>
